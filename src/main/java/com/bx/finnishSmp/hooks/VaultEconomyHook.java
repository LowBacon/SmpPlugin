package com.bx.finnishSmp.hooks;
...
public class VaultEconomyHook extends AbstractEconomy {
    ...
    public VaultEconomyHook(FinnishSmp plugin) {
        this.plugin = plugin;
    }
    ...
    public String currencyNamePlural() {
        return plugin.getCurrencyManager().plural(com.bx.finnishSmp.managers.CurrencyManager.CurrencyType.MONEY);
    }

    @Override
    public String currencyNameSingular() {
        return plugin.getCurrencyManager().singular(com.bx.finnishSmp.managers.CurrencyManager.CurrencyType.MONEY);
    }
    ...
    private EconomyResponse toResponse(com.bx.finnishSmp.models.EconomyTransactionResult result) {
        if (result.success()) {
