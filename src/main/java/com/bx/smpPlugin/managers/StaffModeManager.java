...
import com.bx.smpPlugin.menus.FrozenPlayersMenu;
import com.bx.smpPlugin.menus.StaffListMenu;
...
import com.bx.smpPlugin.staff.StaffModeSession;
import com.bx.smpPlugin.staff.StaffToolType;
...
public class StaffModeManager {
    ...
    public StaffModeManager(SmpPlugin plugin) {
        this.plugin = plugin;
        reloadInternal(true);
    ...
    public String getStaffPermission() {
        return getConfig().getString("STAFF-MODE.STAFF-PERMISSION", "smpplugin.STAFF.MODE");
    }

    public String getAdminPermission() {
        return getConfig().getString("STAFF-MODE.ADMIN-PERMISSION", "smpplugin.ADMIN.STAFFMODE");
    }

    public String getVanishPermission() {
        return getConfig().getString("STAFF-MODE.VANISH-PERMISSION", "smpplugin.STAFF.MODE.VANISH");
    }

    public String getBetterViewPermission() {
        return getConfig().getString("STAFF-MODE.BETTER-VIEW-PERMISSION", "smpplugin.STAFF.MODE.BETTERVIEW");
    }

    public String getStaffListPermission() {
        return getConfig().getString("STAFF-MODE.STAFF-LIST-PERMISSION", "smpplugin.STAFF.MODE.STAFFLIST");
    }

    public String getRandomTeleportPermission() {
        return getConfig().getString("STAFF-MODE.RANDOM-TELEPORT-PERMISSION", "smpplugin.STAFF.MODE.RANDOMTP");
    }

    public String getSeeVanishedPermission() {
        return getConfig().getString("STAFF-MODE.SEE-VANISHED-PERMISSION", "smpplugin.STAFF.MODE.SEEVANISHED");
    }

    public String getOthersPermission() {
        return getConfig().getString("STAFF-MODE.OTHERS-PERMISSION", "smpplugin.STAFF.MODE.OTHERS");
    }
    ...
    public boolean isStaffMember(Player player) {
        ...
        return PermissionUtils.has(player, getStaffPermission())
                ...
                || PermissionUtils.has(player, "smpplugin.staff.invsee")
                || PermissionUtils.has(player, "smpplugin.staff.profileviewer")
                || PermissionUtils.has(player, "smpplugin.staff.punishments.view")
                || PermissionUtils.has(player, "smpplugin.staff.punishments.create")
                || PermissionUtils.has(player, "smpplugin.staff.punishments.remove")
                || PermissionUtils.has(player, "smpplugin.staff.punishments.ban")
                || PermissionUtils.has(player, "smpplugin.staff.punishments.unban")
                || PermissionUtils.has(player, "smpplugin.staff.punishments.mute")
                || PermissionUtils.has(player, "smpplugin.staff.punishments.unmute")
                || PermissionUtils.has(player, "smpplugin.staff.punishments.blacklist")
                || PermissionUtils.has(player, "smpplugin.staff.punishments.unblacklist")
                || PermissionUtils.has(player, "smpplugin.staff.punishments.delete");
    }
