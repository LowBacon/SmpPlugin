...
class WorthManagerTest {
    ...
    void enchantedItemAddsEnchantmentValueToTotalWorth() throws Exception {
        ...
        FinnishSmp plugin = createMockPlugin(worthConfig);
    ...
    private FinnishSmp createMockPlugin(org.bukkit.configuration.file.YamlConfiguration worthConfig) throws Exception {
        ...
        java.lang.reflect.Constructor<?> newConstructor = reflectionFactory.newConstructorForSerialization(FinnishSmp.class, objectConstructor);
        FinnishSmp plugin = (FinnishSmp) newConstructor.newInstance();
        ...
        java.lang.reflect.Field cmField = FinnishSmp.class.getDeclaredField("configManager");
        ...
        org.bukkit.plugin.PluginDescriptionFile pdf = new org.bukkit.plugin.PluginDescriptionFile("FinnishSmp", "1.0", "com.bx.finnishSmp.FinnishSmp");
