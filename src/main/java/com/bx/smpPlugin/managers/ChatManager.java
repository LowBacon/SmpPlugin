...
public class ChatManager {
    ...
    public ChatManager(SmpPlugin plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean isMuteBypassed(Player player) {
        return player != null && PermissionUtils.has(player, "smpplugin.staff.chat.bypass.mute");
    }

    public boolean isDelayBypassed(Player player) {
        return player != null && PermissionUtils.has(player, "smpplugin.staff.chat.bypass.delay");
    }

    public boolean isFilterBypassed(Player player) {
        return player != null && PermissionUtils.has(player, "smpplugin.staff.chat.bypass.filter");
    }
