...
public class ShopMenu extends BaseMenu {
    ...
    public ShopMenu(SmpPlugin plugin) {
        this(plugin, null, 0, false);
    }

    public ShopMenu(SmpPlugin plugin, String menuSection) {
        this(plugin, menuSection, 0, false);
    }

    public ShopMenu(SmpPlugin plugin, String menuSection, int page) {
        this(plugin, menuSection, page, false);
    }

    public ShopMenu(SmpPlugin plugin, boolean favoritesMenu, int page) {
        this(plugin, null, page, favoritesMenu);
    }

    private ShopMenu(SmpPlugin plugin, String menuSection, int page, boolean favoritesMenu) {
        super(
                plugin,
    ...
    private static String resolveTitle(SmpPlugin plugin, String menuSection, boolean favoritesMenu) {
    ...
    private static int resolveSize(SmpPlugin plugin, String menuSection, boolean favoritesMenu) {
        FileConfiguration config = plugin.getConfigManager().getShop();
