...
import com.bx.smpPlugin.models.PunishmentState;
...
public class PunishmentManager {
    ...
    public static final String VIEW_PERMISSION = "smpplugin.staff.punishments.view";
    public static final String DELETE_PERMISSION = "smpplugin.staff.punishments.delete";
    private static final Pattern MINECRAFT_USERNAME = Pattern.compile("^[A-Za-z0-9_]{3,16}$");

    private final SmpPlugin plugin;

    public PunishmentManager(SmpPlugin plugin) {
        this.plugin = plugin;
    }
    ...
    public Optional<PunishmentRecord> getActiveRecord(UUID targetUuid, PunishmentType type) {
        ...
        List<PunishmentRecord> records = getHistory(
                ...
                1,
                0,
                new PunishmentQuery(type, com.bx.smpPlugin.models.PunishmentFilterState.ACTIVE, null)
        );
