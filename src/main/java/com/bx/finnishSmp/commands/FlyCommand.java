...
public class FlyCommand implements CommandExecutor {
    ...
    private static final String PERMISSION = "finnishsmp.staff.fly";

    private final FinnishSmp plugin;

    public FlyCommand(FinnishSmp plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length == 0) {
            ...
            String playerFlyPerm = plugin.getConfigManager().getConfig()
                    .getString("FLY-SYSTEM.PLAYER-FLY-PERMISSION", "finnishsmp.player.fly");
