...
import com.bx.smpPlugin.models.PortalDefinition;
...
public class PortalManagerCommand implements CommandExecutor {
    ...
    private static final String PORTAL_MANAGER_PERMISSION = "smpplugin.admin.portalmanager";

    private final SmpPlugin plugin;

    public PortalManagerCommand(SmpPlugin plugin) {
        this.plugin = plugin;
    }
