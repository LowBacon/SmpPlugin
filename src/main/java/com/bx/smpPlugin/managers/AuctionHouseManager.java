...
import com.bx.smpPlugin.models.AuctionBrowseEngine;
import com.bx.smpPlugin.models.AuctionCategory;
import com.bx.smpPlugin.models.AuctionClaim;
import com.bx.smpPlugin.models.AuctionListing;
import com.bx.smpPlugin.models.AuctionPage;
import com.bx.smpPlugin.models.EconomyReason;
import com.bx.smpPlugin.models.PlayerAuctionSession;
import com.bx.smpPlugin.models.PlayerPreference;
import com.bx.smpPlugin.storage.AuctionHouseRepository;
...
public final class AuctionHouseManager {
    ...
    public AuctionHouseManager(SmpPlugin plugin) {
        this.plugin = plugin;
    ...
    public int getMaxActiveListings(Player player) {
        ...
        resolved = Math.max(resolved, PermissionUtils.resolveHighestExactNumberedPermission(
                player,
                "smpplugin.auctionhouse.",
                MAX_PERMISSION_VALUE
        ));
        resolved = Math.max(resolved, PermissionUtils.resolveHighestExactNumberedPermission(
                player,
                "smpplugin.auctionhouse.limit.",
                MAX_PERMISSION_VALUE
        ));
        resolved = Math.max(resolved, PermissionUtils.resolveHighestExactNumberedPermission(
                player,
    ...
    private boolean hasPermission(Player player, String action) {
        return PermissionUtils.has(player, "smpplugin.auctionhouse." + action)
