...
public class CuboidWandListener implements Listener {
    ...
    public CuboidWandListener(FinnishSmp plugin) {
        this.plugin = plugin;
    }
    ...
    public void onInteract(PlayerInteractEvent event) {
        ...
        if (!PermissionUtils.has(player, "finnishsmp.admin.cuboid")) {
            return;
        }
    ...
    public static void markAsCuboidWand(FinnishSmp plugin, ItemStack item) {
    ...
    private static boolean hasWandMarker(ItemMeta meta) {
        FinnishSmp instance = FinnishSmp.getInstance();
