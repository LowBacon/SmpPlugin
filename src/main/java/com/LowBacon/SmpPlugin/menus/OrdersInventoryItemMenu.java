...
public class OrdersInventoryItemMenu extends BaseMenu {
    ...
    public OrdersInventoryItemMenu(FinnishSmp plugin) {
    ...
    public OrdersInventoryItemMenu(FinnishSmp plugin, long editOrderId, OrdersManager.OrderEditNavigation editNavigation) {
        super(plugin, plugin.getOrdersManager().getInventoryItemTitle(), plugin.getOrdersManager().getInventoryItemSize());
