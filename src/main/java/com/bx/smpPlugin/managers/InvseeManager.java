...
import com.bx.smpPlugin.invsee.InvseeHolder;
import com.bx.smpPlugin.invsee.InvseeSession;
...
public class InvseeManager {
    ...
    public InvseeManager(SmpPlugin plugin) {
        this.plugin = plugin;
        reload();
    }
    ...
    public String getViewPermission() {
        return getConfig().getString("INVSEE.VIEW-PERMISSION", "smpplugin.STAFF.INVSEE");
    }

    public String getModifyPermission() {
        return getConfig().getString("INVSEE.MODIFY-PERMISSION", "smpplugin.STAFF.INVSEE.MODIFY");
    }

    public String getAdminPermission() {
        return getConfig().getString("INVSEE.ADMIN-PERMISSION", "smpplugin.ADMIN.INVSEE");
    }
