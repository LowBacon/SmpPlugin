...
import com.bx.finnishSmp.menus.CrateRewardMenu.OpenContext;
...
public class CratesMenu extends BaseMenu {
    ...
    public CratesMenu(FinnishSmp plugin) {
        super(
                plugin,
    ...
    private org.bukkit.inventory.ItemStack createSimpleItem(
        ...
        org.bukkit.inventory.ItemStack item = com.bx.finnishSmp.utils.ItemUtils.createItem(
                display.material(),
        ...
        com.bx.finnishSmp.utils.ItemUtils.addEnchantments(item, display.enchantments());
