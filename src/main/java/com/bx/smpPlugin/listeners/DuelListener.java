...
import com.bx.smpPlugin.managers.DuelManager;
...
public class DuelListener implements Listener {
    ...
    public DuelListener(SmpPlugin plugin) {
        this.plugin = plugin;
    }
    ...
    public void onDamage(EntityDamageEvent event) {
        ...
        if (event.getCause() == EntityDamageEvent.DamageCause.FALL
                && plugin.getDuelManager().hasArenaSetting(uuid, com.bx.smpPlugin.managers.DuelManager.ArenaSetting.NO_FALL_DAMAGE)) {
            event.setCancelled(true);
            return;
        }
    ...
    public void onFoodChange(FoodLevelChangeEvent event) {
        ...
        UUID uuid = player.getUniqueId();
        if (!plugin.getDuelManager().hasArenaSetting(uuid, com.bx.smpPlugin.managers.DuelManager.ArenaSetting.NO_HUNGER)) {
            return;
        }
