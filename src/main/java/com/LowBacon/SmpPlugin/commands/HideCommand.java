...
import com.bx.finnishSmp.menus.DisguiseAliasMenu;
import com.bx.finnishSmp.menus.DisguiseSkinMenu;
import com.bx.finnishSmp.menus.HideListMenu;
import com.bx.finnishSmp.menus.HideMenu;
...
public class HideCommand implements CommandExecutor, TabCompleter {
    ...
    public HideCommand(FinnishSmp plugin) {
        this.plugin = plugin;
    }
    ...
    public void sendResult(CommandSender sender, HideManager.Result result) {
        ...
        switch (result.type()) {
            case SUCCESS -> {
                ...
                String key = result.state().mode() == com.bx.finnishSmp.models.HideMode.SCRAMBLE
                        ? "SCRAMBLED"
                        : "DISGUISED";
