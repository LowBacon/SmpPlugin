package com.bx.smpPlugin.hooks;
...
public class VaultEconomyHook extends AbstractEconomy {
    ...
    public VaultEconomyHook(SmpPlugin plugin) {
        this.plugin = plugin;
    }
    ...
    public String currencyNamePlural() {
        return plugin.getCurrencyManager().plural(com.bx.smpPlugin.managers.CurrencyManager.CurrencyType.MONEY);
    }

    @Override
    public String currencyNameSingular() {
        return plugin.getCurrencyManager().singular(com.bx.smpPlugin.managers.CurrencyManager.CurrencyType.MONEY);
    }
    ...
    private EconomyResponse toResponse(com.bx.smpPlugin.models.EconomyTransactionResult result) {
        if (result.success()) {
