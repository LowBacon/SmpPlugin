...
public class CuboidWandListener implements Listener {
    ...
    public CuboidWandListener(SmpPlugin plugin) {
        this.plugin = plugin;
    }
    ...
    public void onInteract(PlayerInteractEvent event) {
        ...
        if (!PermissionUtils.has(player, "smpplugin.admin.cuboid")) {
            return;
        }
    ...
    public static void markAsCuboidWand(SmpPlugin plugin, ItemStack item) {
    ...
    private static boolean hasWandMarker(ItemMeta meta) {
        SmpPlugin instance = SmpPlugin.getInstance();
