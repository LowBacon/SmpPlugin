...
public class FlyCommand implements CommandExecutor {
    ...
    private static final String PERMISSION = "smpplugin.staff.fly";

    private final SmpPlugin plugin;

    public FlyCommand(SmpPlugin plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length == 0) {
            ...
            String playerFlyPerm = plugin.getConfigManager().getConfig()
                    .getString("FLY-SYSTEM.PLAYER-FLY-PERMISSION", "smpplugin.player.fly");
