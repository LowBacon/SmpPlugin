...
public class StatsCommand implements CommandExecutor {
    ...
    public StatsCommand(FinnishSmp plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        player.sendMessage(ColorUtils.toComponent(plugin.getCurrencyManager().color(com.bx.finnishSmp.managers.CurrencyManager.CurrencyType.MONEY)
                + plugin.getCurrencyManager().symbol(com.bx.finnishSmp.managers.CurrencyManager.CurrencyType.MONEY)
                + " &f" + plugin.getCurrencyManager().plural(com.bx.finnishSmp.managers.CurrencyManager.CurrencyType.MONEY)
                + ": " + plugin.getCurrencyManager().formatMoneyCompact(data.getMoney())));
        player.sendMessage(ColorUtils.toComponent(plugin.getCurrencyManager().color(com.bx.finnishSmp.managers.CurrencyManager.CurrencyType.SHARDS)
                + plugin.getCurrencyManager().symbol(com.bx.finnishSmp.managers.CurrencyManager.CurrencyType.SHARDS)
                + " &f" + plugin.getCurrencyManager().plural(com.bx.finnishSmp.managers.CurrencyManager.CurrencyType.SHARDS)
