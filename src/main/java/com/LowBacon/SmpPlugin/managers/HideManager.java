...
public class HideManager {
    ...
    public static final String SCRAMBLE_PERMISSION = "finnishsmp.hide.scramble";
    public static final String DISGUISE_PERMISSION = "finnishsmp.hide.disguise";
    public static final String ADMIN_PERMISSION = "finnishsmp.hide.admin";
    public static final String BYPASS_PERMISSION = "finnishsmp.hide.bypass";
    ...
    public HideManager(FinnishSmp plugin) {
        this.plugin = plugin;
