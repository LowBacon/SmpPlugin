...
public class ShardManager {
    ...
    public ShardManager(SmpPlugin plugin) {
        this.plugin = plugin;
    ...
    private void expireBooster(UUID uuid, boolean notifyPlayer) {
        ...
        player.sendMessage(com.bx.smpPlugin.utils.ColorUtils.toComponent(expiredMessage));
    ...
    public String getEverywhereRequiredPermission() {
        return emptyToNull(plugin.getConfigManager().getConfig()
                .getString("SHARDS.EVERYWHERE.REQUIRED-PERMISSION", "smpplugin.SHARDS.EVERYWHERE"));
    }
