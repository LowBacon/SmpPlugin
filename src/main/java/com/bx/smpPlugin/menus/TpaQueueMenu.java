...
public class TpaQueueMenu extends BaseMenu {
    ...
    public TpaQueueMenu(SmpPlugin plugin, boolean tpaHere) {
        this(plugin, tpaHere, 0);
    }

    public TpaQueueMenu(SmpPlugin plugin, boolean tpaHere, int page) {
    ...
    private static String configuredTitle(SmpPlugin plugin, boolean tpaHere) {
