package com.bx.finnishSmp;

import com.bx.finnishSmp.amethyst.*;
import com.bx.finnishSmp.api.EconomyExpansion;
import com.bx.finnishSmp.api.EconomyLeaderboardExpansion;
import com.bx.finnishSmp.api.EconomyRankExpansion;
import com.bx.finnishSmp.api.HideExpansion;
import com.bx.finnishSmp.api.FinnishSmpExpansion;
import com.bx.finnishSmp.api.FsmpExpansion;
import com.bx.finnishSmp.commands.*;
import com.bx.finnishSmp.hooks.VaultEconomyHook;
import com.bx.finnishSmp.listeners.*;
import com.bx.finnishSmp.managers.*;
import com.bx.finnishSmp.tasks.*;
import com.bx.finnishSmp.utils.ColorUtils;
import com.bx.finnishSmp.utils.SpigotScheduler;
...
public final class FinnishSmp extends JavaPlugin {

    private static FinnishSmp instance;
    ...
    public void onEnable() {
        ...
        if (getServer().getPluginManager().isPluginEnabled("PlaceholderAPI")) {
            ...
            new FinnishSmpExpansion(this).register();
        ...
        syncCommands();
        getLogger().info("FinnishSmp enabled successfully.");
    }
    ...
    public void onDisable() {
        ...
        getLogger().info("FinnishSmp disabled.");
    }
    ...
    private boolean checkPlaceholderApi() {
        ...
        getLogger().warning("Core FinnishSmp features will continue with built-in values and fallbacks.");
        return false;
    }
    ...
    private void registerCommands() {
        ...
        setExecutor("addplaytime", new AddPlaytimeCommand(this));
        setExecutor("addkills", new AddKillsCommand(this));
        setExecutor("adddeaths", new AddDeathsCommand(this));
        ...
        setExecutor("smpplugin", lobbyCommand);
        ...
        FinnishSmpCommand finnishSmpCommand = new FinnishSmpCommand(this);
        setExecutor("finnishsmp", finnishSmpCommand);
        setTabCompleter("finnishsmp", finnishSmpCommand);
        ...
        AFKLoungeCommand afkLoungeCommand = new AFKLoungeCommand(this);
        setExecutor("afklounge", afkLoungeCommand);
        setTabCompleter("afklounge", afkLoungeCommand);
    ...
    public static FinnishSmp getInstance() {
        return instance;
    }
