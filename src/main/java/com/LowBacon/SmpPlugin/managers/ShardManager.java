...
public class ShardManager {
    ...
    public ShardManager(FinnishSmp plugin) {
        this.plugin = plugin;
    ...
    private void expireBooster(UUID uuid, boolean notifyPlayer) {
        ...
        player.sendMessage(com.bx.finnishSmp.utils.ColorUtils.toComponent(expiredMessage));
    ...
    public String getEverywhereRequiredPermission() {
        return emptyToNull(plugin.getConfigManager().getConfig()
                .getString("SHARDS.EVERYWHERE.REQUIRED-PERMISSION", "FINNISHSMP.SHARDS.EVERYWHERE"));
    }
