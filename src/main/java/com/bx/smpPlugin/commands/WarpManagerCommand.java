...
public class WarpManagerCommand implements CommandExecutor {
    ...
    private static final String WARP_MANAGER_PERMISSION = "smpplugin.admin.warpmanager";
    private static final String SET_WARP_PERMISSION = "smpplugin.admin.setwarp";
    private static final String DELETE_WARP_PERMISSION = "smpplugin.admin.delwarp";

    private final SmpPlugin plugin;

    public WarpManagerCommand(SmpPlugin plugin) {
        this.plugin = plugin;
    }
