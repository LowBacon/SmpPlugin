...
import com.bx.smpPlugin.commands.HideCommand;
...
public class DisguiseSkinMenu extends BaseMenu {
    ...
    public DisguiseSkinMenu(SmpPlugin plugin, String aliasKey, int page) {
    ...
    private static String title(SmpPlugin plugin, int page) {
