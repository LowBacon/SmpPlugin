...
import com.bx.smpPlugin.managers.EnchantmentsManager;
import com.bx.smpPlugin.managers.EnchantmentsManager.EnchantOption;
...
public class EnchantSelectMenu extends BaseMenu {
    ...
    public EnchantSelectMenu(SmpPlugin plugin, Player player, Material material) {
