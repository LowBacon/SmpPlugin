...
import com.bx.finnishSmp.menus.ServerInfoMenu;
...
public class HelpCommand implements CommandExecutor {
    ...
    public HelpCommand(FinnishSmp plugin) {
        this.plugin = plugin;
    }
    ...
    private void sendLegacyHelp(Player player) {
        ...
        sendHelpLine(player, "shards", "&b/shards &7- check your "
                + plugin.getCurrencyManager().plural(com.bx.finnishSmp.managers.CurrencyManager.CurrencyType.SHARDS));
