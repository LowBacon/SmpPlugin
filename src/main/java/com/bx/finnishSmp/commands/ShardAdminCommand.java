...
import com.bx.finnishSmp.managers.EconomyManager;
...
public class ShardAdminCommand implements CommandExecutor {
    ...
    private static final String PERMISSION = "finnishsmp.admin.shards";

    private final FinnishSmp plugin;

    public ShardAdminCommand(FinnishSmp plugin) {
        this.plugin = plugin;
    }
