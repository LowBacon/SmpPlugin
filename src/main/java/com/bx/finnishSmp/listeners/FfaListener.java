...
public class FfaListener implements Listener {
    ...
    public FfaListener(FinnishSmp plugin) {
        this.plugin = plugin;
    }
    ...
    public void onDamage(EntityDamageEvent event) {
        ...
        if (event.getCause() == EntityDamageEvent.DamageCause.FALL
                && plugin.getFfaManager().hasArenaSetting(uuid, com.bx.finnishSmp.managers.FfaManager.ArenaSetting.NO_FALL_DAMAGE)) {
            event.setCancelled(true);
            return;
        }
    ...
    public void onFoodChange(FoodLevelChangeEvent event) {
        ...
        UUID uuid = player.getUniqueId();
        if (!plugin.getFfaManager().hasArenaSetting(uuid, com.bx.finnishSmp.managers.FfaManager.ArenaSetting.NO_HUNGER)) {
            return;
        }
    ...
    public void onCommand(PlayerCommandPreprocessEvent event) {
        ...
        if (PermissionUtils.has(event.getPlayer(), "finnishsmp.admin.ffa")) {
            return;
        }
