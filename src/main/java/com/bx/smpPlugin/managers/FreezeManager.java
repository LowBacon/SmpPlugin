...
import com.bx.smpPlugin.freeze.FreezeSession;
...
public class FreezeManager {
    ...
    public FreezeManager(SmpPlugin plugin) {
        this.plugin = plugin;
        reload();
    }
    ...
    public String getStaffPermission() {
        return getConfig().getString("FREEZE.STAFF-PERMISSION", "smpplugin.STAFF.FREEZE");
    }

    public String getAlertPermission() {
        return getConfig().getString("FREEZE.ALERT-PERMISSION", "smpplugin.STAFF.FREEZE.ALERT");
    }

    public String getExemptPermission() {
        return getConfig().getString("FREEZE.EXEMPT-PERMISSION", "smpplugin.STAFF.FREEZE.EXEMPT");
    }

    public String getAdminPermission() {
        return getConfig().getString("FREEZE.ADMIN-PERMISSION", "smpplugin.ADMIN.FREEZE");
    }
