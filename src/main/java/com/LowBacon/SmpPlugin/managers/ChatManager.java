...
public class ChatManager {
    ...
    public ChatManager(FinnishSmp plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean isMuteBypassed(Player player) {
        return player != null && PermissionUtils.has(player, "finnishsmp.staff.chat.bypass.mute");
    }

    public boolean isDelayBypassed(Player player) {
        return player != null && PermissionUtils.has(player, "finnishsmp.staff.chat.bypass.delay");
    }

    public boolean isFilterBypassed(Player player) {
        return player != null && PermissionUtils.has(player, "finnishsmp.staff.chat.bypass.filter");
    }
