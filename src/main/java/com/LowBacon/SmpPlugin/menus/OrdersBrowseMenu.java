...
public class OrdersBrowseMenu extends BaseMenu {
    ...
    public OrdersBrowseMenu(FinnishSmp plugin, int page, OrderSort sortMode, String categoryFilter) {
        this(plugin, page, sortMode, categoryFilter, "");
    }

    public OrdersBrowseMenu(FinnishSmp plugin, int page, OrderSort sortMode, String categoryFilter, String query) {
