...
public class ChatCommand implements CommandExecutor {
    ...
    private static final String BASE_PERMISSION = "smpplugin.staff.chat.use";
    private static final String MUTE_PERMISSION = "smpplugin.staff.chat.mute";
    private static final String UNMUTE_PERMISSION = "smpplugin.staff.chat.unmute";
    private static final String DELAY_PERMISSION = "smpplugin.staff.chat.delay";
    private static final String CLEAR_PERMISSION = "smpplugin.staff.chat.clear";

    private final SmpPlugin plugin;

    public ChatCommand(SmpPlugin plugin) {
        this.plugin = plugin;
    }
