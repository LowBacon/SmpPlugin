...
class RTPManagerTest {
    ...
    private FinnishSmp createMockPlugin(YamlConfiguration rtpConfig) throws Exception {
        Constructor<Object> objectConstructor = Object.class.getConstructor();
        ReflectionFactory reflectionFactory = ReflectionFactory.getReflectionFactory();
        Constructor<?> newConstructor = reflectionFactory.newConstructorForSerialization(FinnishSmp.class, objectConstructor);
        ...
        Field cmField = FinnishSmp.class.getDeclaredField("configManager");
    ...
    void testGetLoadedNormalWorldNameExcludesSpawnHubDenied() throws Exception {
        ...
        FinnishSmp plugin = createMockPlugin(rtpConfig);
