...
public class MediaMenu extends BaseMenu {
    ...
    public MediaMenu(SmpPlugin plugin) {
    ...
    private static int configuredSlot(SmpPlugin plugin, int inventorySize) {
    ...
    private static Material configuredMaterial(SmpPlugin plugin) {
