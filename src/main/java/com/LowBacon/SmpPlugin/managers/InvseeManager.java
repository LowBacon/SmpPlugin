...
import com.bx.finnishSmp.invsee.InvseeHolder;
import com.bx.finnishSmp.invsee.InvseeSession;
...
public class InvseeManager {
    ...
    public InvseeManager(FinnishSmp plugin) {
        this.plugin = plugin;
        reload();
    }
    ...
    public String getViewPermission() {
        return getConfig().getString("INVSEE.VIEW-PERMISSION", "FINNISHSMP.STAFF.INVSEE");
    }

    public String getModifyPermission() {
        return getConfig().getString("INVSEE.MODIFY-PERMISSION", "FINNISHSMP.STAFF.INVSEE.MODIFY");
    }

    public String getAdminPermission() {
        return getConfig().getString("INVSEE.ADMIN-PERMISSION", "FINNISHSMP.ADMIN.INVSEE");
    }
