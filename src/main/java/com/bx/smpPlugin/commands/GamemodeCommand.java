...
public class GamemodeCommand implements CommandExecutor, TabCompleter {
    ...
    private static final String PERMISSION = "smpplugin.staff.gamemode";
    private static final String OTHERS_PERMISSION = "smpplugin.staff.gamemode.others";
    private static final List<String> MODE_COMPLETIONS = List.of("survival", "creative", "adventure", "spectator");

    private final SmpPlugin plugin;

    public GamemodeCommand(SmpPlugin plugin) {
        this.plugin = plugin;
    }
