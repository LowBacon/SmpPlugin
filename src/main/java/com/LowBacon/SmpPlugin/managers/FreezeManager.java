...
import com.bx.finnishSmp.freeze.FreezeSession;
...
public class FreezeManager {
    ...
    public FreezeManager(FinnishSmp plugin) {
        this.plugin = plugin;
        reload();
    }
    ...
    public String getStaffPermission() {
        return getConfig().getString("FREEZE.STAFF-PERMISSION", "FINNISHSMP.STAFF.FREEZE");
    }

    public String getAlertPermission() {
        return getConfig().getString("FREEZE.ALERT-PERMISSION", "FINNISHSMP.STAFF.FREEZE.ALERT");
    }

    public String getExemptPermission() {
        return getConfig().getString("FREEZE.EXEMPT-PERMISSION", "FINNISHSMP.STAFF.FREEZE.EXEMPT");
    }

    public String getAdminPermission() {
        return getConfig().getString("FREEZE.ADMIN-PERMISSION", "FINNISHSMP.ADMIN.FREEZE");
    }
