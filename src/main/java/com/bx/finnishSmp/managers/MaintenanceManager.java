...
public class MaintenanceManager {
    ...
    private static final String REDIS_MAINTENANCE_CHANNEL = "finnishsmp:maintenance";
    ...
    public MaintenanceManager(FinnishSmp plugin) {
        this.plugin = plugin;
    ...
    public void startMaintenance() {
        ...
        String bypassPerm = config.getString("MAINTENANCE.BYPASS_PERMISSION", "FINNISHSMP.ADMIN.MAINTENANCE.BYPASS");
