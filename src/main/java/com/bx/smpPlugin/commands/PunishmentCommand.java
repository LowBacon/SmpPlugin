...
import com.bx.smpPlugin.managers.PunishmentManager;
...
public class PunishmentCommand implements CommandExecutor {
    ...
    private static final String CREATE_PERMISSION = "smpplugin.staff.punishments.create";
    private static final String BAN_PERMISSION = "smpplugin.staff.punishments.ban";
    private static final String UNBAN_PERMISSION = "smpplugin.staff.punishments.unban";
    private static final String MUTE_PERMISSION = "smpplugin.staff.punishments.mute";
    private static final String UNMUTE_PERMISSION = "smpplugin.staff.punishments.unmute";
    private static final String BLACKLIST_PERMISSION = "smpplugin.staff.punishments.blacklist";
    private static final String UNBLACKLIST_PERMISSION = "smpplugin.staff.punishments.unblacklist";
    ...
    public PunishmentCommand(SmpPlugin plugin) {
        this.plugin = plugin;
    }
