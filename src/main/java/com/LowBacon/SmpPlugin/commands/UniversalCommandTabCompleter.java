...
import com.bx.finnishSmp.models.DuelArena;
import com.bx.finnishSmp.models.FfaArena;
...
public class UniversalCommandTabCompleter implements TabCompleter {
    ...
    public UniversalCommandTabCompleter(FinnishSmp plugin) {
        this.plugin = plugin;
    }
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String alias, String[] args) {
        ...
        return switch (commandName) {
            ...
            case "enderchest" -> completeReloadOnly(sender, args, "finnishsmp.admin.enderchest");
            ...
            case "freeze" -> completePlayerOrReload(sender, args, "finnishsmp.admin.freeze", false);
            case "fly", "heal", "feed" -> completeOnlinePlayer(args, sender, true);
            case "staffmode" -> completePlayerOrReload(sender, args, "finnishsmp.admin.staffmode", true);
            ...
            case "invsee" -> completePlayerOrReload(sender, args, "finnishsmp.admin.invsee", false);
    ...
    private List<String> completeOrders(CommandSender sender, String[] args) {
        ...
        if (has(sender, "finnishsmp.admin.orders")) {
            options.add("reload");
        }
    ...
    private List<String> completeDuel(CommandSender sender, String[] args) {
        if (args.length == 1) {
            ...
            if (has(sender, "finnishsmp.admin.duels")) {
                options.add("reload");
            }
            return partial(args[0], options);
        }
    ...
    private List<String> completeFfa(CommandSender sender, String[] args) {
        if (args.length == 1) {
            ...
            if (has(sender, "finnishsmp.admin.ffa")) {
                options.add("arena");
                options.add("reload");
            }
            return partial(args[0], options);
    ...
    private List<String> completeAuctionHouse(CommandSender sender, String[] args) {
        if (args.length == 1) {
            ...
            if (has(sender, "finnishsmp.admin.auctionhouse")) {
                options.add("reload");
            }
            return partial(args[0], options);
        }
    ...
    private List<String> completeWorth(CommandSender sender, String[] args) {
        ...
        if (has(sender, "finnishsmp.admin.worth")) {
            options.add("reload");
        }
        return partial(args[0], options);
    }
    ...
    private List<String> completeShards(CommandSender sender, String[] args) {
        if (args.length == 1) {
            ...
            if (has(sender, "finnishsmp.admin.shards")) {
                options.add("everywhere");
            }
            return partial(args[0], options);
        }
        if (!normalize(args[0]).equals("everywhere") || !has(sender, "finnishsmp.admin.shards")) {
            return List.of();
        }
        if (args.length == 2) {
    ...
    private List<String> completeSpawner(CommandSender sender, String[] args) {
        boolean admin = has(sender, "finnishsmp.admin.spawner");
        if (args.length == 1) {
    ...
    private List<String> completeCuboid(CommandSender sender, String[] args) {
        if (!has(sender, "finnishsmp.admin.cuboid")) {
            return List.of();
        }
        if (args.length == 1) {
    ...
    private List<String> completeShop(CommandSender sender, String[] args) {
        return completeReloadOnly(sender, args, "finnishsmp.admin.shop");
    }
