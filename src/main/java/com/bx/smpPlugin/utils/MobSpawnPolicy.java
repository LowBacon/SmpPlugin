...
public final class MobSpawnPolicy {
    ...
    public static void markVanillaSpawnerMob(SmpPlugin plugin, LivingEntity entity) {
    ...
    public static boolean isVanillaSpawnerMob(SmpPlugin plugin, LivingEntity entity) {
        if (plugin == null || entity == null) {
            return false;
        }
