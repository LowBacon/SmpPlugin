...
public class FeatureToggleMenu extends BaseMenu {
    ...
    public FeatureToggleMenu(SmpPlugin plugin) {
        this(plugin, 0);
    }

    public FeatureToggleMenu(SmpPlugin plugin, int page) {
    ...
    private static String configuredTitle(SmpPlugin plugin, int page) {
        return plugin.getConfigManager().getMenus()
