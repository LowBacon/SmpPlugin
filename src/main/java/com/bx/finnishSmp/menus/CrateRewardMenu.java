...
public class CrateRewardMenu extends BaseMenu {
    ...
    public CrateRewardMenu(FinnishSmp plugin, CrateManager.CrateDefinition crate) {
        this(plugin, crate, OpenContext.COMMAND);
    }

    public CrateRewardMenu(FinnishSmp plugin, CrateManager.CrateDefinition crate, OpenContext openContext) {
