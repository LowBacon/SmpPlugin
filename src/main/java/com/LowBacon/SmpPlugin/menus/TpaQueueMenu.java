...
public class TpaQueueMenu extends BaseMenu {
    ...
    public TpaQueueMenu(FinnishSmp plugin, boolean tpaHere) {
        this(plugin, tpaHere, 0);
    }

    public TpaQueueMenu(FinnishSmp plugin, boolean tpaHere, int page) {
    ...
    public void handleClick(int slot, Player player) {
        ...
        if (requesterUuid != null) {
            ...
            if (!plugin.getTPAManager().acceptQueuedRequest(player, requesterUuid, tpaHere)) {
                player.sendMessage(com.bx.finnishSmp.utils.ColorUtils.toComponent(
    ...
    private static String configuredTitle(FinnishSmp plugin, boolean tpaHere) {
