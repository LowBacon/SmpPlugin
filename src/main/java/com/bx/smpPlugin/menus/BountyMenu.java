...
public class BountyMenu extends BaseMenu {
    ...
    public BountyMenu(SmpPlugin plugin) {
        this(plugin, 0, null, true);
    }

    public BountyMenu(SmpPlugin plugin, int page, String searchQuery, boolean descending) {
        super(
                plugin,
    ...
    public void handleClick(int slot, Player player, ClickType clickType) {
        ...
        if (slot == searchSlot) {
            ...
            if (clickType.isRightClick()) {
                ...
                com.bx.smpPlugin.utils.SignInputUtil.openFromConfig(plugin, player, config, text -> {
