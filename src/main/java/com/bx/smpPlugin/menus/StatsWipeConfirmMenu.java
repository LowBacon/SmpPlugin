...
public class StatsWipeConfirmMenu extends BaseMenu {
    ...
    public StatsWipeConfirmMenu(SmpPlugin plugin, StatsWipeManager.WipeTarget target) {
    ...
    private static String configuredTitle(SmpPlugin plugin, StatsWipeManager.WipeTarget target) {
