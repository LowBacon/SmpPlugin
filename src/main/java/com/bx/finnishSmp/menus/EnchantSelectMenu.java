...
import com.bx.finnishSmp.managers.EnchantmentsManager;
import com.bx.finnishSmp.managers.EnchantmentsManager.EnchantOption;
...
public class EnchantSelectMenu extends BaseMenu {
    ...
    public EnchantSelectMenu(FinnishSmp plugin, Player player, Material material) {
