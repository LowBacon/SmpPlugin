...
final class OrdersMenuSupport {
    ...
    static Material material(FinnishSmp plugin, String path, Material fallback) {
    ...
    static String text(FinnishSmp plugin, String path, String fallback, String... placeholders) {
        return plugin.getLanguageManager().text(path, null, fallback, placeholders);
    }

    static List<String> list(FinnishSmp plugin, String path, List<String> fallback, String... placeholders) {
