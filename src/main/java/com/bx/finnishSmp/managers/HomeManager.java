...
import com.bx.finnishSmp.menus.HomeMenu;
...
public class HomeManager {
    ...
    public HomeManager(FinnishSmp plugin) {
        this.plugin = plugin;
    }
    ...
    public int getMaxHomes(Player player) {
        ...
        int homesByAmountPermission = PermissionUtils.resolveHighestExactNumberedPermission(
                player, "finnishsmp.homes.", MAX_PERMISSION_VALUE);
        int pagesByPermission = PermissionUtils.resolveHighestExactNumberedPermission(
                player, "finnishsmp.homes.page.", MAX_PERMISSION_VALUE);
