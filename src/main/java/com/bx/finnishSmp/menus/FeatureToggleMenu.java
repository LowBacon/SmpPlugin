...
public class FeatureToggleMenu extends BaseMenu {
    ...
    public FeatureToggleMenu(FinnishSmp plugin) {
        this(plugin, 0);
    }

    public FeatureToggleMenu(FinnishSmp plugin, int page) {
    ...
    private static String configuredTitle(FinnishSmp plugin, int page) {
        return plugin.getConfigManager().getMenus()
