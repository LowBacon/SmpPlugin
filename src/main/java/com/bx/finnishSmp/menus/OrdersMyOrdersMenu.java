...
public class OrdersMyOrdersMenu extends BaseMenu {
    ...
    public OrdersMyOrdersMenu(FinnishSmp plugin, int ignoredPage, OrderSort sortMode) {
        this(plugin, ignoredPage, sortMode, "");
    }

    public OrdersMyOrdersMenu(FinnishSmp plugin, int ignoredPage, OrderSort sortMode, String query) {
