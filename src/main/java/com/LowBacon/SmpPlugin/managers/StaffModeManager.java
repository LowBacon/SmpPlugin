...
import com.bx.finnishSmp.menus.FrozenPlayersMenu;
import com.bx.finnishSmp.menus.StaffListMenu;
...
import com.bx.finnishSmp.staff.StaffModeSession;
import com.bx.finnishSmp.staff.StaffToolType;
...
public class StaffModeManager {
    ...
    public StaffModeManager(FinnishSmp plugin) {
        this.plugin = plugin;
        reloadInternal(true);
    ...
    public String getStaffPermission() {
        return getConfig().getString("STAFF-MODE.STAFF-PERMISSION", "FINNISHSMP.STAFF.MODE");
    }

    public String getAdminPermission() {
        return getConfig().getString("STAFF-MODE.ADMIN-PERMISSION", "FINNISHSMP.ADMIN.STAFFMODE");
    }

    public String getVanishPermission() {
        return getConfig().getString("STAFF-MODE.VANISH-PERMISSION", "FINNISHSMP.STAFF.MODE.VANISH");
    }

    public String getBetterViewPermission() {
        return getConfig().getString("STAFF-MODE.BETTER-VIEW-PERMISSION", "FINNISHSMP.STAFF.MODE.BETTERVIEW");
    }

    public String getStaffListPermission() {
        return getConfig().getString("STAFF-MODE.STAFF-LIST-PERMISSION", "FINNISHSMP.STAFF.MODE.STAFFLIST");
    }

    public String getRandomTeleportPermission() {
        return getConfig().getString("STAFF-MODE.RANDOM-TELEPORT-PERMISSION", "FINNISHSMP.STAFF.MODE.RANDOMTP");
    }

    public String getSeeVanishedPermission() {
        return getConfig().getString("STAFF-MODE.SEE-VANISHED-PERMISSION", "FINNISHSMP.STAFF.MODE.SEEVANISHED");
    }

    public String getOthersPermission() {
        return getConfig().getString("STAFF-MODE.OTHERS-PERMISSION", "FINNISHSMP.STAFF.MODE.OTHERS");
    }
    ...
    public boolean isStaffMember(Player player) {
        ...
        return PermissionUtils.has(player, getStaffPermission())
                ...
                || PermissionUtils.has(player, "finnishsmp.staff.invsee")
                || PermissionUtils.has(player, "finnishsmp.staff.profileviewer")
                || PermissionUtils.has(player, "finnishsmp.staff.punishments.view")
                || PermissionUtils.has(player, "finnishsmp.staff.punishments.create")
                || PermissionUtils.has(player, "finnishsmp.staff.punishments.remove")
                || PermissionUtils.has(player, "finnishsmp.staff.punishments.ban")
                || PermissionUtils.has(player, "finnishsmp.staff.punishments.unban")
                || PermissionUtils.has(player, "finnishsmp.staff.punishments.mute")
                || PermissionUtils.has(player, "finnishsmp.staff.punishments.unmute")
                || PermissionUtils.has(player, "finnishsmp.staff.punishments.blacklist")
                || PermissionUtils.has(player, "finnishsmp.staff.punishments.unblacklist")
                || PermissionUtils.has(player, "finnishsmp.staff.punishments.delete");
    }
