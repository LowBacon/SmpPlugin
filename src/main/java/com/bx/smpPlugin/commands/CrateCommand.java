...
import com.bx.smpPlugin.menus.CrateGachaMenu;
import com.bx.smpPlugin.menus.CrateRewardMenu;
import com.bx.smpPlugin.menus.CratesMenu;
import com.bx.smpPlugin.menus.KeysMenu;
...
public class CrateCommand implements CommandExecutor, TabCompleter {
    ...
    private static final String ADMIN_PERMISSION = "smpplugin.admin.crate";
    private static final String RELOAD_PERMISSION = "smpplugin.admin.crate.reload";
    private static final String KEYALL_PERMISSION = "smpplugin.admin.crate.keyall";
    ...
    public CrateCommand(SmpPlugin plugin) {
        this.plugin = plugin;
    }
