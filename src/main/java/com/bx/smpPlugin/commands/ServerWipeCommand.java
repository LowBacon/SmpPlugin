...
import com.bx.smpPlugin.managers.ServerWipeManager;
...
public class ServerWipeCommand implements CommandExecutor, TabCompleter {
    ...
    private static final String PERMISSION = "smpplugin.admin.serverwipe";
    private static final List<String> SUBCOMMANDS = List.of("preview", "prepare", "confirm", "cancel", "status");

    private final SmpPlugin plugin;

    public ServerWipeCommand(SmpPlugin plugin) {
        this.plugin = plugin;
    }
