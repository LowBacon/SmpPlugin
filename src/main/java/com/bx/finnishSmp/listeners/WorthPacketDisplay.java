...
import com.bx.finnishSmp.menus.BaseMenu;
...
public class WorthPacketDisplay implements Listener {
    ...
    public WorthPacketDisplay(FinnishSmp plugin) {
        this.plugin = plugin;
    ...
    private void registerPacketListener() {
        final FinnishSmp fsmp = plugin; // packetadapter has its own plugin field
        protocolManager.addPacketListener(new PacketAdapter(plugin, ListenerPriority.NORMAL,
            ...
            public void onPacketSending(PacketEvent event) {
                ...
                if (!fsmp.getWorthManager().isWorthDisplayEnabledFor(player)) {
                    return;
                }
                ...
                if (event.getPacketType() == PacketType.Play.Server.SET_SLOT) {
                    ...
                    ItemStack rendered = fsmp.getWorthManager().renderClientWorthDisplay(item);
                    if (rendered != item) {
