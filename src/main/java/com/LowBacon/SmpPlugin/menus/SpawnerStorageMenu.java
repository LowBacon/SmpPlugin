...
public class SpawnerStorageMenu extends BaseMenu {
    ...
    public SpawnerStorageMenu(FinnishSmp plugin, long spawnerId, int page) {
    ...
    public void build(Player player) {
        ...
        set(lastRow + 4, ItemUtils.createItem(
                ...
                List.of("&7ѕᴇʟʟ ᴀʟʟ ѕᴇʟʟᴀʙʟᴇ ʟᴏᴏᴛ ꜰᴏʀ "
                        + plugin.getCurrencyManager().plural(com.bx.finnishSmp.managers.CurrencyManager.CurrencyType.MONEY)
                        + ".")
        ));
