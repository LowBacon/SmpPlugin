...
public class HideManager {
    ...
    public static final String SCRAMBLE_PERMISSION = "smpplugin.hide.scramble";
    public static final String DISGUISE_PERMISSION = "smpplugin.hide.disguise";
    public static final String ADMIN_PERMISSION = "smpplugin.hide.admin";
    public static final String BYPASS_PERMISSION = "smpplugin.hide.bypass";
    ...
    public HideManager(SmpPlugin plugin) {
        this.plugin = plugin;
