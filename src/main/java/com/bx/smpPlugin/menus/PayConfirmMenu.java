...
import com.bx.smpPlugin.utils.PaymentUtils;
...
public class PayConfirmMenu extends BaseMenu {
    ...
    public PayConfirmMenu(SmpPlugin plugin, String targetName, double amount) {
        super(
                plugin,
    ...
    public PayConfirmMenu(SmpPlugin plugin, String targetName, long amount) {
        super(
                plugin,
                plugin.getConfigManager().getMenus().getString("PAY-CONFIRM-MENU.TITLE", "&8ᴄᴏɴꜰɪʀᴍ ᴘᴀʏᴍᴇɴᴛ"),
                plugin.getConfigManager().getMenus().getInt("PAY-CONFIRM-MENU.SIZE", 27)
