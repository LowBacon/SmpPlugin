...
public class MaintenanceManager {
    ...
    private static final String REDIS_MAINTENANCE_CHANNEL = "smpplugin:maintenance";
    ...
    public MaintenanceManager(SmpPlugin plugin) {
        this.plugin = plugin;
    ...
    public void startMaintenance() {
        ...
        String bypassPerm = config.getString("MAINTENANCE.BYPASS_PERMISSION", "smpplugin.ADMIN.MAINTENANCE.BYPASS");
