...
public class BountyMenu extends BaseMenu {
    ...
    public BountyMenu(FinnishSmp plugin) {
        this(plugin, 0, null, true);
    }

    public BountyMenu(FinnishSmp plugin, int page, String searchQuery, boolean descending) {
        super(
                plugin,
    ...
    public void handleClick(int slot, Player player, ClickType clickType) {
        ...
        if (slot == searchSlot) {
            ...
            if (clickType.isRightClick()) {
                ...
                com.bx.finnishSmp.utils.SignInputUtil.openFromConfig(plugin, player, config, text -> {
