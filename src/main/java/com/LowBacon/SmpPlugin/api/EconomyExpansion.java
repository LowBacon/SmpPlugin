...
public class EconomyExpansion extends PlaceholderExpansion {
    ...
    public EconomyExpansion(FinnishSmp plugin) {
        this.plugin = plugin;
    ...
    @Override
    public @NotNull String getAuthor() { return "FinnishSmp"; }
    ...
    public @Nullable String onRequest(OfflinePlayer offlinePlayer, @NotNull String params) {
        ...
        if (params.equalsIgnoreCase("rtp_countdown")) {
            if (!plugin.getFeatureManager().isEnabled(com.bx.finnishSmp.managers.FeatureManager.Feature.RTP_ZONE)) {
                return "disabled";
            }
            java.util.UUID uuid = offlinePlayer != null ? offlinePlayer.getUniqueId() : null;
        ...
        if (params.equalsIgnoreCase("billford_countdown")) {
            if (!plugin.getFeatureManager().isEnabled(com.bx.finnishSmp.managers.FeatureManager.Feature.BILLFORD)) {
                return "disabled";
            }
        ...
        return switch (params) {
            case "donutplus", "display_donutplus" -> {
                ...
                if (p != null && data.isDisplayDonutPlusEnabled() && (p.hasPermission("finnishsmp.donutplus") || p.hasPermission("donutplus"))) {
                    yield "&d&lDonut+ &r";
                }
                yield "";
            }
